...
class scanMerger : public rclcpp::Node
{
    ...
    void update_point_cloud_rgb(){
        ...
        pc2_msg_->header.stamp = now();// + rclcpp::Duration::from_seconds(0.025);
    ...
    void initialize_params(){
        ...
        this->declare_parameter("pointCloutFrameId","lidar_link");

        this->declare_parameter("scanTopic1","scan1");
        this->declare_parameter("laser1XOff",-0.1075);
        this->declare_parameter("laser1YOff",0.1075);
        this->declare_parameter("laser1ZOff",0.0);
        this->declare_parameter("laser1Alpha",135.0);
        this->declare_parameter("laser1AngleMin",-135.0);
        this->declare_parameter("laser1AngleMax",135.0);
        ...
        this->declare_parameter("laser2XOff",0.1075);
        this->declare_parameter("laser2YOff",-0.1075);
        this->declare_parameter("laser2ZOff",0.0);
        this->declare_parameter("laser2Alpha",315.0);
        this->declare_parameter("laser2AngleMin",-135.0);
        this->declare_parameter("laser2AngleMax",135.0);
    ...
    void refresh_params(){
        ...
        this->get_parameter_or<std::string>("pointCloutFrameId",cloudFrameId_, "lidar_link");
        ...
        this->get_parameter_or<float>("laser1AngleMin",laser1AngleMin_, -135.0);
        this->get_parameter_or<float>("laser1AngleMax",laser1AngleMax_, 135.0);
        ...
        this->get_parameter_or<float>("laser2AngleMin",laser2AngleMin_,-135.0);
        this->get_parameter_or<float>("laser2AngleMax",laser2AngleMax_, 135.0);
