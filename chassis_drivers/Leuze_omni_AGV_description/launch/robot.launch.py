...
def generate_launch_description():
    ...
    urdf_file_name = 'Leuze_omni_AGV.urdf'
    urdf = os.path.join(
        get_package_share_directory('Leuze_omni_AGV_description'), 'urdf',
        urdf_file_name)
    ...
    return LaunchDescription([
        ...
        Node(
            package='Leuze_omni_AGV_description',
        ...
        # Uncomment if you want to include omni kinematics
        # Node(
        #     package='Leuze_omni_AGV_description',
